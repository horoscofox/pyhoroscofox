...
def test_exceptions_raises_nosign_and_date():
    ...
    assert 'No sign allowed, did you mean one of [\'capricorn\', \'acquarius\', \'pisces\', \'aries\', \'taurus\', \'gemini\', \'cancer\', \'leo\', \'virgo\', \'libra\', \'scorpio\', \'sagittarius\']' in str(
        excinfo.value)
...
def test_exceptions_raises_virgo_and_nodate():
    ...
    assert 'No kind allowed, did you mean one of [\'today\', \'tomorrow\']' in str(
        excinfo.value)
